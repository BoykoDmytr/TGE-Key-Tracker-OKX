...
export function allowlistFor(chain) {
    let cfg = DEFAULT_ALLOWLIST;
...
const BLOCKLIST = new Set((process.env.FILTER_CREATOR_BLOCKLIST ||
 ...
 */
export function classifyDeposit(inp) {
    ...
    const sharePpb = (landed * 1000000000n) / totalSupply;
...
export function filterAppliesTo(chain) {
